...
CREATE INDEX IF NOT EXISTS idx_pendencias_ato ON pendencias(ato_id);
CREATE INDEX IF NOT EXISTS idx_pendencias_import_lote ON pendencias(import_lote_id);
CREATE INDEX IF NOT EXISTS idx_pendencias_escrevente ON pendencias(escrevente_id);
